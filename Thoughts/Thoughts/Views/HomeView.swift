...
struct HomeView: View {
    ...
    // ⚡ Bolt: Pre-calculate note counts to avoid O(N*M) filtering in view body
    private func getNoteCounts() -> [UUID: Int] {
        var counts = [UUID: Int]()
        for note in notes {
        ...
        return ZStack {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 24) {
                    ...
                    // Notebooks Section
                    notebooksSection(counts: noteCounts)
